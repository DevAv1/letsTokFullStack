...
export const ProductList: React.FC<Props> = observer(
      ...
      <div className="products-list-view">
        <div className="product-filter-actions">
          <TextField
            ...
            select
            label="ProductNames"
            helperText="Filter by product name..."
          ...
          <TextField
            ...
            select
            label="Brands"
            helperText="Fitler by product brand..."
              ...
              <div className="product-box" key={product.id}>
                ...
                <div className="product-actions">
                  <DeleteIcon
                    ...
                    onClick={() => onDeleteClick(product.id as number)}
                  />
                  <EditIcon
                    sx={{ fontSize: 18 }}
                    color="primary"
